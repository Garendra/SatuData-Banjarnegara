...
import post4 from "assets/img/blog2.jpg";
...
export default (params) => {
    ...
    useEffect(() => {
        (async () => {
            const resPeraturan = await Axios.get(`${API_URL}/api/list/cv_peraturan_terkait`).then(res => res.data.cv_peraturan_terkait);
    ...
    <>
        ...
        <div className="h-screen">
            ...
            <main className="flex mt-10 px-10 w-full  p-4  items-center flex-col md:flex-row" id="faq">
            ...
            <div className="w-full flex items-center justify-center" style={{height: '60%'}}>
                ...
                >
                    ...
                    <div className="w-11/12 bg-blueGray-200 rounded-lg shadow-lg h-full flex flex-col items-center justify-center p-2">
                        <p className="  font-semibold  text-blue  text-center">Sistem Akuntabilitas Kinerja Instansi Pemerintah  </p>
                        
                    <img
                        alt="..."
                        src={require("assets/img/landing.jpg").default}
                        className="w-11/12 bg-blueGray-200 rounded-lg shadow-lg h-full flex flex-col items-center justify-center p-2"
                      />
                        </div>
                    </SwiperSlide>
                    ...
                    <SwiperSlide className="w-4/12 p-2">
                    <div className="w-11/12 bg-blueGray-200 rounded-lg shadow-lg h-full flex flex-col items-center justify-center p-2"> 
                        <p className="font-semibold text-lg text-center">Sistem Akuntabilitas Kinerja Instansi Pemerintah 2 </p>
                    <img
                        alt="..."
                        src={require("assets/img/blog3.jpg").default}
                        className="w-11/12 bg-white rounded-lg shadow-lg h-full flex flex-col items-center justify-center p-2"
                      />
                        </div>
                    </SwiperSlide>
                    ...
                    <SwiperSlide className="w-4/12 p-2">
                    <div className="w-11/12 bg-blueGray-200 rounded-lg shadow-lg h-full flex flex-col items-center justify-center p-2">
                        <p className="font-semibold text-lg text-center">Sistem Akuntabilitas Kinerja Instansi Pemerintah 3  </p>
                    <img
                        alt="..."
                        src={require("assets/img/blog4.jpg").default}
                        className="w-11/12 bg-white rounded-lg shadow-lg h-full flex flex-col items-center justify-center p-2"
                      />
                        </div>
                    </SwiperSlide>
                    {/* <SwiperSlide className="w-4/12 p-2">
                        <div className="w-11/12 bg-white rounded-lg shadow-lg h-full flex flex-col items-center justify-center p-2">
                            <p className="text-sm font-light text-center">Instansi Pemerintah (SAKIP)</p>
        ...
        <main className="flex mt-20 px-20 w-full  p-4  items-center flex-col md:flex-row" id="faq">
            <div className="w-full md:w-5/12 mr-auto ml-auto mb-4 ">
            </div>
        ...
        <main className="flex mt-10 px-10 w-full bg-blueGray-500 p-4  items-center flex-col md:flex-row" id="faq">
            <div className="w-full md:w-5/12 mr-auto ml-auto mb-4 ">
